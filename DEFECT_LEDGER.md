...
**Result:** A design rule now prescribes the check. No automated liveness test running these checks on a recurring basis was established by the audit that found this defect. See `incidents/001-configured-is-not-running.md`.
